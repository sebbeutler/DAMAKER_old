...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.splitter_vertical1_1.addWidget(self.dock1_2)
        self.dock1_3 = ContentDock(self.splitter_vertical1_1)
        self.dock1_3.setObjectName(u"dock1_3")
        sizePolicy.setHeightForWidth(self.dock1_3.sizePolicy().hasHeightForWidth())
        self.dock1_3.setSizePolicy(sizePolicy)
        self.dock1_3.setStyleSheet(u"")
        self.splitter_vertical1_1.addWidget(self.dock1_3)
