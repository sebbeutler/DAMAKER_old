...
step2_E1 = pipeline.add(loadChannelsFromDir, input_dir, "E1.tif")
step2_E2 = pipeline.add(loadChannelsFromDir, input_dir, "E2.tif")
step2_E3 = pipeline.add(loadChannelsFromDir, input_dir, "E3.tif")
step2_E4 = pipeline.add(loadChannelsFromDir, input_dir, "E4.tif")
step2_E5 = pipeline.add(loadChannelsFromDir, input_dir, "E5.tif")
